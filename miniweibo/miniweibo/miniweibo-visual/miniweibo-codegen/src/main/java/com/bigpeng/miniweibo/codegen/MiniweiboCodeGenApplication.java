...
package com.bigpeng.miniweibo.codegen;

import com.bigpeng.miniweibo.common.datasource.annotation.EnableDynamicDataSource;
...
public class MiniweiboCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(MiniweiboCodeGenApplication.class, args);
	}
