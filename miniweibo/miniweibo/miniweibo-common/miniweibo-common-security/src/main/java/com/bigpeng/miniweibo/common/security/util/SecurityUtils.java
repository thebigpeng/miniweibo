...
package com.bigpeng.miniweibo.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public MiniweiboUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof MiniweiboUser) {
			return (MiniweiboUser) principal;
		}
		return null;
	}
