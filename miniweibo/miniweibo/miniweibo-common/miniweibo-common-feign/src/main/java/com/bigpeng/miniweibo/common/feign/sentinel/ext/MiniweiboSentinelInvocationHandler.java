 ...
 */
@Slf4j
public class MiniweiboSentinelInvocationHandler implements InvocationHandler {
	...
	MiniweiboSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MiniweiboSentinelInvocationHandler other = (MiniweiboSentinelInvocationHandler) obj;
