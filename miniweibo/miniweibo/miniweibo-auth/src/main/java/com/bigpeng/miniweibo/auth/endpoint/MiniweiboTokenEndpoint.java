...
package com.bigpeng.miniweibo.auth.endpoint;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.bigpeng.miniweibo.admin.api.entity.SysOauthClientDetails;
import com.bigpeng.miniweibo.admin.api.feign.RemoteClientDetailsService;
import com.bigpeng.miniweibo.admin.api.vo.TokenVo;
import com.bigpeng.miniweibo.auth.support.handler.MiniweiboAuthenticationFailureEventHandler;
import com.bigpeng.miniweibo.common.core.constant.CacheConstants;
import com.bigpeng.miniweibo.common.core.constant.CommonConstants;
import com.bigpeng.miniweibo.common.core.constant.SecurityConstants;
import com.bigpeng.miniweibo.common.core.util.R;
import com.bigpeng.miniweibo.common.core.util.RetOps;
...
import com.bigpeng.miniweibo.common.security.util.OAuth2EndpointUtils;
import com.bigpeng.miniweibo.common.security.util.OAuth2ErrorCodesExpand;
import com.bigpeng.miniweibo.common.security.util.OAuthClientException;
...
public class MiniweiboTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new MiniweiboAuthenticationFailureEventHandler();
